defmodule UmrahBookingWeb.UserLiveTest do
  use UmrahBookingWeb.ConnCase

  import Phoenix.LiveViewTest
  import UmrahBooking.AccountsFixtures

  @create_attrs %{name: "some name", role: "some role", email: "some email", password_hash: "some password_hash", created_at: "2025-07-30T08:54:00", updated_at: "2025-07-30T08:54:00"}
  @update_attrs %{name: "some updated name", role: "some updated role", email: "some updated email", password_hash: "some updated password_hash", created_at: "2025-07-31T08:54:00", updated_at: "2025-07-31T08:54:00"}
  @invalid_attrs %{name: nil, role: nil, email: nil, password_hash: nil, created_at: nil, updated_at: nil}
